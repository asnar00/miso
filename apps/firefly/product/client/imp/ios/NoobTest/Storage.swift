...
class Storage {
    ...
    // Login state
    func saveLoginState(email: String, userId: Int, name: String, isLoggedIn: Bool) {
    ...
    func getLoginState() -> (email: String?, userId: Int?, name: String?, isLoggedIn: Bool) {
        ...
        return (email, userId, name, isLoggedIn)
    }
