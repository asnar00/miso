#!/usr/bin/env python3
"""
Real-time iOS log viewer for NoobTest app
...
def main():
    ...
    print("📱 Watching logs from NoobTest...")
    ...
    # Format: timestamp NoobTest{subsystem}[pid] <LEVEL>: [APP] message
    log_pattern = re.compile(r'NoobTest\{[^}]+\}\[\d+\] <(DEBUG|INFO|NOTICE|WARNING|ERROR|FAULT)>: \[APP\] (.+)')
